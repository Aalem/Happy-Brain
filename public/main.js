                ...
                if (_this.mentor_subjects.length !== 0) {
                    for (_this.j = 0; _this.j < _this.mentor_subjects.length; _this.j++) {
                        if (data[_this.i]._id === _this.mentor_subjects[_this.j]) {
                            ...
                            _this.subjects[_this.i].hasSubject = true;
